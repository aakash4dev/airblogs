...
// source: airblogs/airblogs/blog.proto
...
type AirPost struct {
	...
	ServersideData string `protobuf:"bytes,6,opt,name=serversideData,proto3" json:"serversideData,omitempty"`
}
...
func (*AirPost) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a82a3191c5d1e19, []int{0}
}
...
func (m *AirPost) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *AirPost) GetServersideData() string {
	if m != nil {
		return m.ServersideData
	}
	return ""
}
...
func init() { proto.RegisterFile("airblogs/airblogs/blog.proto", fileDescriptor_1a82a3191c5d1e19) }

var fileDescriptor_1a82a3191c5d1e19 = []byte{
	// 212 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *AirPost) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ServersideData) > 0 {
		i -= len(m.ServersideData)
		copy(dAtA[i:], m.ServersideData)
		i = encodeVarintBlog(dAtA, i, uint64(len(m.ServersideData)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Body) > 0 {
	...
	if len(m.Imgurl) > 0 {
		...
		i = encodeVarintBlog(dAtA, i, uint64(len(m.Imgurl)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Title) > 0 {
	...
	if m.Id != 0 {
		i = encodeVarintBlog(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *AirPost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServersideData", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ServersideData = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
