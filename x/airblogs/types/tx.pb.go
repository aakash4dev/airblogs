...
func (*MsgCreateComment) Descriptor() ([]byte, []int) {
	return fileDescriptor_70c743910c7f2a33, []int{4}
}
...
func (*MsgCreateCommentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_70c743910c7f2a33, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*MsgCreateComment)(nil), "airblogs.airblogs.MsgCreateComment")
	proto.RegisterType((*MsgCreateCommentResponse)(nil), "airblogs.airblogs.MsgCreateCommentResponse")
}
...
var fileDescriptor_70c743910c7f2a33 = []byte{
	...
	,
}
...
func (c *msgClient) CreateComment(ctx context.Context, in *MsgCreateComment, opts ...grpc.CallOption) (*MsgCreateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/airblogs.airblogs.Msg/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/airblogs.airblogs.Msg/CreateComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
